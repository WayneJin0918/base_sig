...
export CKPT_NAME="cambrian-8b-finetune-llm-finetuning-0p1-7m-dpo-2e-7-l-on-v-on-new-proj-salt-25"
...
resume="/home/wayneyjin/cambrian-8b-finetune-llm-finetuning-0p1-7m-dpo-2e-7-l-on-v-on-new-proj-salt-25/checkpoint-10000"
...
TRAIN_ARGS="
    ...
    --tune_llm_self_attention_only False \
